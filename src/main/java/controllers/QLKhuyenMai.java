...
public class QLKhuyenMai {
    ...
    public static void fillAllToCbo(JComboBox<String> cbo) {
    ...
    public static void fillToCboByToday(JComboBox<String> cbo) {
        DefaultComboBoxModel<String> model = (DefaultComboBoxModel<String>) cbo.getModel();
        model.removeAllElements();
    ...
    public static void fillToCboByDates(JComboBox<String> cbo, String... ids) {
        DefaultComboBoxModel<String> model = (DefaultComboBoxModel<String>) cbo.getModel();
        model.removeAllElements();
