...
public class TestDelete_NhanVien {
	static Login login;
	String maNV;
    String matKhau;
    String hoTenNV;
	...
	public TestDelete_NhanVien(String maNV, String matKhau, String hoTenNV, String gioiTinh, Date ngaySinh,
	...
	public void test() {
		...
		QLNguyenLieu.detele(maNV);
		String result = null;
		if (QLNguyenLieu.alert.equals("Xóa thành công!")) {
